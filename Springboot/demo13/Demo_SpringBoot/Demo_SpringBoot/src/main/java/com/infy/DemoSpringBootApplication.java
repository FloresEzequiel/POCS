...
public class DemoSpringBootApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("The customer service1 output="+service1.fetchCustomer());
		service1.setCount(20);
		System.out.println("Yhe customerservice1 output after setmethod="+service1.fetchCustomer());
